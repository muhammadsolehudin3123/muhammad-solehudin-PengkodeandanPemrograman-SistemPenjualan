...
<html lang="en">
    <head>
        ...
        <title>Data Pelanggan - Muhammad Solehudin Comp</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Muhammad Solehudin Comp</a>
            <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Selamat datang di website penjualanMuhammad Solehudin Comp</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><h4>Pelanggan : <?=$h2;?></h4></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$notelp;?></td>
                                            <td><?=$alamat;?></td>
                                            <td><button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idpl;?>">    
                                                Edit
                                                </button> 
